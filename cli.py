...
# NOTE (W-78): git worktree / maintenance helpers extracted to
# hermes_cli/git_worktree.py to continue the phased decomposition of cli.py.
# Re-imported so call sites and behavior are unchanged.
from hermes_cli.git_worktree import (
    _cleanup_worktree,
    _git_repo_root,
    _load_full_config,
