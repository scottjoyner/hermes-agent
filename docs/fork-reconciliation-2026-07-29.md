...
- Fork default branch: `scottjoyner/hermes-agent@e88963ad6e52444ae9b6ab12b770e3f7e75112a3`
- Upstream default branch: `NousResearch/hermes-agent@41a07f5b8451f88a8b8b5adfc0cfdc2ada0a1f90`
- Merge base: `2517917de34eeb6a40f5a17a2e59d9746803dfa5`
- Fork divergence: 27 commits ahead and 9,585 commits behind upstream.
...
- `reconcile/upstream-2026-07-29` — exact upstream state at the SHA above.

The reconciliation branch was compared against upstream and was identical at creation time.
...
Use `reconcile/upstream-2026-07-29` as the new baseline. Re-port only durable capabilities as isolated plugins/providers/skills, each in its own branch and pull request.
...
- Make chain-of-thought storage opt-in and disabled by default.
- Retain durable queueing, session backfill, document indexing, embedding failover, and tests.
...
```bash
git fetch origin
git switch reconcile/upstream-2026-07-29

# Use the upstream-supported development layout.
...
git fetch origin
git switch main
git reset --hard origin/reconcile/upstream-2026-07-29
